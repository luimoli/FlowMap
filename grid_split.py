...
def getGirdDict(grid_map=(5,15)):
    ...
    for i in range(grid_map[1] + 1):
        ...
        for j in range(grid_map[0] + 1):
            ...
            print((xx / scale_longitube + pad_longitube, yy / scale_latitube + pad_latitube))
        co_map.append(row)
    # print(co_map)
...
def plot_grid():
    ...
    gmap = gmplot.GoogleMapPlotter(30.686572, 104.085808, 12)
